import { type Border, BorderIndex as BI, type Theme } from "../../theme.ts";
...
export class SeparateLayout implements Layout {
  ...
  style2({ border }: Theme): { input: Border; list: Border } {
    return {
      input: [
        border[BI.TopLeft],
        border[BI.Top],
  ...
  style3({ border }: Theme): { input: Border; list: Border; preview: Border } {
    return {
      input: [
        border[BI.TopLeft],
        border[BI.Top],
